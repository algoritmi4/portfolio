const styles = {
  ...
  heroHeadText:
    'font-black text-eerieBlack lg:text-[80px] sm:text-[60px] xs:text-[50px] xs:leading-[60px] text-[40px] leading-[50px] sm:leading-[70px] lg:leading-[90px] mt-2',
  heroSubText:
    'text-eerieBlack font-medium lg:text-[30px] sm:text-[26px] xs:text-[25px] xs:leading-[30px] text-[16px] sm:leading-[30px] lg:leading-[40px]',
