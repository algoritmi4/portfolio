  ...
  return (
    <motion.div
      ...
      <div
        ...
        <h3 className="text-taupe text-[18px] font-bold text-center whitespace-pre-wrap">
          {title}
        </h3>
      </div>
    </motion.div>
...
const About = () => {
  return (
    <div className="-mt-[6rem] pt-[100px]">
      ...
      <motion.p
        ...
        Fan of Basketball, outdoor activities, video games, and coding of course.
